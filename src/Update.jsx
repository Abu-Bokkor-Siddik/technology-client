...
const Update = () => {
    ...
    fetch(`https://server-ass-side-2wbl1ssjj-mdmasud01833798650-gmailcom.vercel.app/add/${data._id}`,{
        method:"PUT",
        headers:{
...
<form onSubmit={updatainfo}  className=" w-auto lg:w-[700px] shadow-2xl mx-auto mt-40 p-16  dark:bg-black">
              ...
              <div className="form-control mt-6">
                <button type='submit' className="btn btn-primary dark:bg-black dark:text-white">Submit</button>
              </div>
            </form>
