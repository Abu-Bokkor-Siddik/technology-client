...
const Footer = () => {
  return (
    ...
    <footer className="footer footer-center dark:bg-black p-10 bg-blue-500 text-primary-content">
  <aside>
    ...
    Technology and Electronics. <br/>Providing reliable tech since 1992
    </p> 
